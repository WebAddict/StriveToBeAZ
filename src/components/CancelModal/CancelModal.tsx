...
const CancelModal: React.FC<CancelModalProps> = ({ isOpen, closeModal, submitCancel }) => {
            ...
            <div className="bg-gray-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <h3 className="text-base font-semibold text-gray-300" id="modal-title">
                    Cancel your registration
                  </h3>
                  <div className="mt-2">
                    <p className="text-sm text-gray-300">
                      Are you sure you want to cancel your registration? All of your data will be permanently removed. This action cannot be undone.
                    </p>
                  </div>
                </div>
              </div>
